...
_The fairy flute_ by Rose Fyleman

## Project Info
* Project Name: flute
* Title: The fairy flute
* Author: Rose Fyleman
* [Project Page](https://www.pgdp.net/c/project.php?id=projectID672abb8a2e63f)
* [Project Comments](https://www.pgdp.net/c/project.php?id=projectID672abb8a2e63f#project-comments)
* [Project Forum](https://www.pgdp.net/phpBB3/viewtopic.php?t=82545)
* [Github Repository](https://github.com/matteverett/pgdp_flute)
...
* [x] Remove end-of-line spaces (Regex: ` \n`)
...
* [ ] Use `File → Save a Copy As` to make `flute.html`
...
* [ ] Re-open `flute-utf8.txt` (if not still open).
...
### Generate the HTML
* [ ] Open `flute.html` that was saved previously.
...
* [ ] `make sr`
* [ ] Go to [project page](https://www.pgdp.net/c/project.php?id=projectID672abb8a2e63f), select SR time period, upload `flute-sr.zip`
...
* [ ] Add **anonymized** files to git, e.g. `flute-smoothread01.txt`
...
* [ ] Enter copyright clearance (get from DP [project page](https://www.pgdp.net/c/project.php?id=projectID672abb8a2e63f))
...
* [ ] Credits line
  * Paste in from DP [project page](https://www.pgdp.net/c/project.php?id=projectID672abb8a2e63f)
